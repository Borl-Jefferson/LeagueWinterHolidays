public class SnowMan {
  ...
  private void drawArms() {
    ...
    if (mouseY < armY) {
      ...
      lmidfingery += (fingerlength*sin(thetaL));
      ofingery += (fingerlength*sin(thetaL + radians(-fingerankle)));
      rightfingery += (fingerlength*sin(thetaL + radians(fingerankle)));
      rmidfingery += (fingerlength*sin(thetaL));
      oofingery += (fingerlength*sin(thetaL + radians(-fingerankle)));
    }
    ...
    if (mouseX < rightArmX) {
      rmidfingerx -= (fingerlength*cos(thetaL));
      rightfingerx -= (fingerlength*cos(thetaL + radians(fingerankle)));
      oofingerx -= (fingerlength*cos(thetaL + radians(-fingerankle)));
    } else {
      rightfingerx +=  (fingerlength*cos(thetaL));
      rightfingerx += (fingerlength*cos(thetaL + radians(fingerankle)));
      ofingerx += (fingerlength*cos(thetaL + radians(-fingerankle)));
    }
